...
-- Schema ulabeler
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ulabeler` DEFAULT CHARACTER SET utf8mb4 ;
USE `ulabeler` ;

-- -----------------------------------------------------
-- Table `ulabeler`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`user` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`delivery_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`delivery_address` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`vendor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`vendor` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`category_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`category_settings` (
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`base_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`base_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `vendor_id` INT NOT NULL,
  `name_category` VARCHAR(45) NOT NULL,
  `name_subcategory` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `vendor_id`
    ...
    REFERENCES `ulabeler`.`vendor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `category_settings_name`
    FOREIGN KEY (`name_subcategory`)
    REFERENCES `ulabeler`.`category_settings` (`name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `ulabeler`.`work`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`work` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `category_id`
    ...
    REFERENCES `ulabeler`.`base_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ulabeler`.`purchase_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`purchase_history` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`favorited_work`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`favorited_work` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`base_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`base_settings` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`stamp_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`stamp_settings` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`favorited_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`favorited_user` (
  `favorite_from` VARCHAR(15) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`report` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`mail_confirmation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`mail_confirmation` (
  `user_id` VARCHAR(15) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`password_reset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`password_reset` (
  `id` VARCHAR(15) NOT NULL,
  `datetime_issue` DATETIME NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`work_used_stamps`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`work_used_stamps` (
  ...
  CONSTRAINT `id_stamp`
    ...
    REFERENCES `ulabeler`.`stamp_settings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ulabeler`.`administrator`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`administrator` (
  `id` VARCHAR(15) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`inquiry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`inquiry` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` VARCHAR(15) NOT NULL,
  ...
  CONSTRAINT `admin_id_inq`
    ...
    REFERENCES `ulabeler`.`administrator` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ulabeler`.`delivery_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`delivery_status` (
  ...
  CONSTRAINT `purchase_record_id`
    ...
    REFERENCES `ulabeler`.`purchase_history` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ulabeler`.`sample_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`sample_images` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ulabeler`.`favorited_user_number`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`favorited_user_number` (
...
-- -----------------------------------------------------
-- Table `ulabeler`.`favorited_work_number`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulabeler`.`favorited_work_number` (
