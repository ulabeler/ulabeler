...
-- Schema ulabeler_dev
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ulabeler_dev` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `ulabeler_dev` ;
...
CREATE TABLE IF NOT EXISTS `ulabeler_dev`.`user` (
  ...
  `self_introduction` TEXT NULL DEFAULT NULL,
  `cardnumber` CHAR(16) NULL DEFAULT NULL,
  `name_card` VARCHAR(45) NULL DEFAULT NULL,
  `expiration` CHAR(4) NULL DEFAULT NULL,
  `created_at` DATETIME NOT NULL,
  `deleted_at` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ulabeler_dev`.`delivery_status` (
  ...
  `familyname` VARCHAR(15) NOT NULL,
  `firstname` VARCHAR(15) NOT NULL,
  `familyname_furigana` VARCHAR(45) NULL DEFAULT NULL,
  `firstname_furigana` VARCHAR(45) NULL DEFAULT NULL,
  `datetime_results` DATETIME NULL DEFAULT NULL COMMENT '配送実績日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT 'ユーザー購入履歴/管理画面で対象ページアクセスしたときに入れる',
...
CREATE TABLE IF NOT EXISTS `ulabeler_dev`.`mail_confirmation` (
  ...
  `mailaddress_new` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ulabeler_dev`.`sample_images` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sample_images_path` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ulabeler_dev`.`work_used_stamps` (
  ...
  `num_used` INT NULL DEFAULT NULL,
